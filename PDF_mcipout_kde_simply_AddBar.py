...
COMPARE_YEARS = [2060]  # 只与 2023 对比的年份
MONTHS = ["01", "07"]
REGIONS = ["normal"]  # 只绘制广东全域，不画惠州单独区域

# 统一变量配置
VARIABLES = {
    "TA_mean": {"col": "TA_mean", "unit": "°C", "title": "TA_Mean"},
    "TA_max":  {"col": "TA_max",  "unit": "°C", "title": "TEMP_Max"},
}
...
def get_filepath(year: int, month: str, region: str):
    """自动生成 MCIP 文件路径"""
    folder = "mcipout_processed_HuiZhou" if region == "huizhou" else "mcipout_processed"
