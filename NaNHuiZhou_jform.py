...
input_dir = "./cmaqout_processed/"             # 输入文件夹路径
output_dir = "./cmaqout_processed_HuiZhou/"    # 输出文件夹路径

# 指定要处理的文件名列表
target_files = [
    "2023_Emission[2023met]_01.csv",
    "2023_Emission[2023met]_07.csv",
    "2060_Emission[2060met]_07.csv"
]
